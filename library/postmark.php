 ...
 * @modified    Added attachment code by Daniel Morris, DJM - 2010-08-29
 * @link        http://www.github.com/zackkitzmiller/postmark-codeigniter
*/

function show_error($message) {
    echo '<p>Error: ' . $message . '</p>';
    echo '<p>Please report this error by email to operations@eScribers.net.</p>';
    echo '<p>Thank You. </p>';
    exit;
}
...
class postmark {
    ...
    //private
    //var $CI;
    var $api_key = 'e693656a-4d70-438a-bf93-7302277af635';
     ...
     * @return void
     */
    function attachment($name, $content, $contenttype)
    {
        if (!is_null($name) && !is_null($content) && !is_null($contenttype)) {
            $att = new StdClass();
            $att->Name = $name;
            $att->Content = base64_encode($content);
